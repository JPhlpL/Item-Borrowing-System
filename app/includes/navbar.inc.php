...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
 ...
 <!--<li class="nav-item">
      <a class="nav-link bordered rounded bg-dark" role="button">
        <label class="mr-1">Today is: </label>
        <label id="date" class="mr-2"></label>
        <label id="digital-clock"></label>
      </a>
    </li> -->
    ...
    <a href="addtocart.php" class="nav-link">
        ...
        <span class="badge badge-danger navbar-badge"><?php CountAllItems(); ?></span>
      </a>
    </li>
